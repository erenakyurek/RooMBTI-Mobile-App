...
class EditProfileHouseRenterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_edit_profile_house_renter)
        ...
        matchingRecyclerView = findViewById(R.id.matching_recycler_view)
    ...
    private fun loadMatches() {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            try {
                val matches = MatchingAlgorithm.getMatchingUsers(userId, this@EditProfileHouseRenterActivity)
                matchingAdapter.submitList(matches)
            } catch (e: Exception) {
                Toast.makeText(this@EditProfileHouseRenterActivity, 
